...
export const PremiumHero = () => {
  ...
  const aiTitles = ["websites", "online stores", "brand identities", "your vision", "a new chapter"];
      ...
      <div className="relative z-20 flex h-screen w-full items-center justify-center px-6 text-center">
        <div className="container mx-auto flex flex-col items-center gap-12 text-center">
          <h1 className="text-5xl md:text-7xl max-w-2xl tracking-tighter font-regular">
            <span className="text-white">We bring to life</span>
          ...
          <p className="text-lg md:text-xl leading-relaxed tracking-tight text-muted-foreground max-w-2xl text-center mt-8">
            AlignedFlow Systems builds fast, beautiful websites for wellness coaches, spiritual creators,
            and small businesses across the UK and Poland. No templates. No surprises.
          </p>
