...
|------|------|-------------|
| [user_profile.md](user_profile.md) | user | Solo founder Mateusz Dobosz — London-based web dev, AlignedFlow Systems, cyan-600 dark theme stack |
| [project_team_page.md](project_team_page.md) | project | /team page built 2026-03-16 — files created, founder profile details, nav updated |
| [project_voice_and_conventions.md](project_voice_and_conventions.md) | project | Copy rules: first-person I/me/my, "Get a Quote" CTA, no avatar photos, realistic stats |
